...
suds_logger.setLevel(logging.ERROR)
# rotating_logger = logging.handlers.TimedRotatingFileHandler('logs/sf_rest_proxy_suds','midnight')
# rotating_logger_fmt = logging.Formatter('[=] %(asctime)s | %(levelname)s | %(message)s')
# rotating_logger.setFormatter(rotating_logger_fmt)
# suds_logger.addHandler(rotating_logger)
